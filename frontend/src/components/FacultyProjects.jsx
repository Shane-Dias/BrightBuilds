  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="relative min-h-fit p-4 sm:p-6 md:p-8 min-w-fit faculty-projects-mobile"
      ...
      >
        <div className="relative z-10">
          ...
          <motion.div
            className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 faculty-projects-grid"
            initial="hidden"
            animate="visible"
            variants={{
              hidden: { opacity: 0 },
